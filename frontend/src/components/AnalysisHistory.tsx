      ...
      <div className="text-center py-12">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-500 text-sm mb-4">
            No strategic analyses have been created yet. Your completed analyses will be stored here for future reference.
          </p>
          <p className="text-gray-400 text-xs">
            Note: Analysis data is stored on the server, not locally on your device.
          </p>
        </div>
      </div>
    );
